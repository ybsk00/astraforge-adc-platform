        ...
        "steps": [
            {
                ...
                "parameters": {
                    "cell_lines": ["Target-High", "Target-Low", "Target-Negative"]
                },
                "duration_hours": 72.0,
            },
            {
...
class ProtocolGeneratorService:
    ...
    def _check_trigger(
        self, rule: str, score_components: Dict[str, Any], threshold: float
    ) -> bool:
        """트리거 규칙 체크"""
        # 각 fit 타입의 terms 확인
    ...
    def _create_protocol(self, candidate_id: str, template: Dict[str, Any]) -> Protocol:
        """템플릿에서 프로토콜 생성"""
        steps = []
