...
class ReportOrchestrator:
    ...
    async def _round1_harvest(self):
        ...
        self.log.info(
            "round1_harvest_completed", evidence_count=len(self.report_data["evidence"])
        )
        ...
        self.report_data["design_candidates"] = [
            {
                ...
                "claims": [
                    {"text": "High stability in plasma", "evidence_ids": ["EV-001"]}
                ],
            }
        ]
    ...
    async def _round3_compose_and_qa(self):
        ...
        self.report_data["executive_summary"] = (
            "This report analyzes HER2-targeted ADC candidates..."
        )
